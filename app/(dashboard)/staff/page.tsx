...
export default async function StaffPage() {
  ...
  const getRoleBadge = (role: string) => {
    switch (role) {
      ...
      case 'TRAINER':
        return <Badge className="bg-blue-100 text-blue-800"><Briefcase className="h-3 w-3 mr-1" />Trainer</Badge>
      case 'RECEPTIONIST':
        return <Badge className="bg-green-100 text-green-800"><User className="h-3 w-3 mr-1" />Receptionist</Badge>
      default:
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="space-y-1 text-sm text-blue-800">
          ...
          <li><strong>Trainer:</strong> Can manage members, workouts, diet plans, and attendance</li>
          <li><strong>Receptionist:</strong> Can manage members, attendance, payments, and leads</li>
        </ul>
      </div>
    </div>
  )
