...
export async function getGymDashboardStats(gymProfileId: string) {
	const cached = unstable_cache(
		...
		["dashboard:getGymDashboardStats", gymProfileId],
		{ revalidate: 60 }
	);
	...
	const cached = unstable_cache(
		async () => {
			...
			const gymsWithNoRevenueLast30Days = await prisma.gymProfile.count({
				where: { id: { notIn: gymsWithRevenueIds } },
			});
		...
		["dashboard:getSuperAdminDashboardStats"],
		{ revalidate: 60 }
	);
...
export async function getTopGymsByRevenue(params?: {
	...
	const cached = unstable_cache(
		...
		["dashboard:getTopGymsByRevenue", String(days), String(limit)],
		{ revalidate: 300 }
	);
...
export async function getRecentActivityGlobal(limit: number = 20) {
	...
	const cached = unstable_cache(
		...
		["dashboard:getRecentActivityGlobal", String(limit)],
		{ revalidate: 30 }
	);
...
export async function getRecentActivityForGymProfile(
	...
	const cached = unstable_cache(
		...
		["dashboard:getRecentActivityForGymProfile", gymProfileId, String(limit)],
		{ revalidate: 30 }
	);
...
export async function getSuperAdminRevenueChart(months: number = 6) {
	...
	const cached = unstable_cache(
		...
		["dashboard:getSuperAdminRevenueChart", String(months)],
		{ revalidate: 300 }
	);
...
export async function getSuperAdminMemberStatusChart() {
	...
	const cached = unstable_cache(
		...
		["dashboard:getSuperAdminMemberStatusChart"],
		{ revalidate: 300 }
	);
...
export async function getSuperAdminLeadsBreakdown() {
	...
	const cached = unstable_cache(
		...
		["dashboard:getSuperAdminLeadsBreakdown"],
		{ revalidate: 300 }
	);
...
export async function getSuperAdminAttendanceTrend(days: number = 14) {
	...
	const cached = unstable_cache(
		...
		["dashboard:getSuperAdminAttendanceTrend", String(days)],
		{ revalidate: 300 }
	);
...
export async function getSuperAdminMemberGrowth(months: number = 6) {
	...
	const cached = unstable_cache(
		...
		["dashboard:getSuperAdminMemberGrowth", String(months)],
		{ revalidate: 300 }
	);
...
export async function getSuperAdminPaymentModes() {
	...
	const cached = unstable_cache(
		...
		["dashboard:getSuperAdminPaymentModes"],
		{ revalidate: 300 }
	);
