export const foodDatabase = [
  ...
  { name: 'Greek Yogurt', calories: 100, protein: 10, carbs: 6, fat: 0.4, category: 'PROTEIN' },
  ...
  { name: 'Cottage Cheese', calories: 98, protein: 11, carbs: 3.4, fat: 4.3, category: 'PROTEIN' },
  { name: 'Paneer', calories: 265, protein: 18, carbs: 3.6, fat: 20, category: 'PROTEIN' },
  ...
  { name: 'Oats', calories: 389, protein: 17, carbs: 66, fat: 6.9, category: 'CARBS' },
  ...
  { name: 'Roti', calories: 297, protein: 11, carbs: 53, fat: 4.2, category: 'CARBS' },
  { name: 'Pasta', calories: 131, protein: 5.1, carbs: 25, fat: 1.1, category: 'CARBS' },
  ...
  { name: 'Cucumber', calories: 16, protein: 0.7, carbs: 3.6, fat: 0.1, category: 'VEGETABLES' },
  { name: 'Bell Pepper', calories: 31, protein: 1, carbs: 6, fat: 0.3, category: 'VEGETABLES' },
  ...
  { name: 'Berries', calories: 57, protein: 0.7, carbs: 14, fat: 0.3, category: 'FRUITS' },
  ...
  // Snacks
  { name: 'Protein Bar', calories: 200, protein: 20, carbs: 25, fat: 8, category: 'SNACKS' },
  { name: 'Protein Shake', calories: 120, protein: 24, carbs: 3, fat: 1.5, category: 'SNACKS' },
  { name: 'Hummus', calories: 166, protein: 8, carbs: 14, fat: 10, category: 'SNACKS' },
  { name: 'Dark Chocolate', calories: 598, protein: 8, carbs: 46, fat: 43, category: 'SNACKS' },
]
