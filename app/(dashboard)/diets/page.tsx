...
import { Plus, UtensilsCrossed, User, Calendar, Target, Flame } from 'lucide-react'
                ...
                <div className="space-y-2 text-sm">
                  {plan.calorieTarget && (
                    <div className="flex items-center gap-2 text-gray-600">
                      ...
                      <span>{plan.calorieTarget} kcal/day</span>
                    </div>
                  )}
                  <div className="flex items-center gap-2 text-gray-600">
                    <UtensilsCrossed className="h-4 w-4" />
                    <span>{(plan.meals as any[]).length} meals/day</span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-600">
                  ...
                  <div className="grid grid-cols-3 gap-2 pt-2 text-xs">
                    {plan.proteinTarget && (
                      <div className="text-center p-2 bg-purple-50 rounded">
                        <div className="font-semibold text-purple-700">{plan.proteinTarget}g</div>
                        <div className="text-gray-600">Protein</div>
                      </div>
                    )}
                    {plan.carbTarget && (
                      <div className="text-center p-2 bg-blue-50 rounded">
                        <div className="font-semibold text-blue-700">{plan.carbTarget}g</div>
                        <div className="text-gray-600">Carbs</div>
                      </div>
                    )}
                    {plan.fatTarget && (
                      <div className="text-center p-2 bg-yellow-50 rounded">
                        <div className="font-semibold text-yellow-700">{plan.fatTarget}g</div>
      ...
      <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
        ...
        <CardContent>
          <ul className="space-y-2 text-sm text-gray-700">
            <li>• Customize diet plans based on member goals and dietary preferences</li>
            <li>• Track macros (protein, carbs, fats) for balanced nutrition</li>
