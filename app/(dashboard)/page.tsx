...
import { Users, UserCheck, IndianRupee, Calendar, TrendingUp, AlertCircle } from 'lucide-react'
      ...
      <Card className="border-blue-200 bg-blue-50/50">
        ...
        <CardContent className="space-y-3">
          <p className="text-sm text-muted-foreground">
            Welcome to Pro Bodyline Fitness CRM! To get started, you need to set up your database:
          </p>
          <div className="space-y-2 text-sm">
            ...
            <p className="font-mono bg-white p-3 rounded border">
              <strong>Step 2:</strong> Run <code className="bg-gray-100 px-2 py-1 rounded">npm run db:push</code> to create tables
            </p>
            <p className="font-mono bg-white p-3 rounded border">
              <strong>Step 3:</strong> Run <code className="bg-gray-100 px-2 py-1 rounded">npm run db:seed</code> to add sample data
            </p>
            <p className="font-mono bg-white p-3 rounded border">
              <strong>Step 4:</strong> Login with: <code className="bg-gray-100 px-2 py-1 rounded">admin@probodyline.com / admin123</code>
            </p>
          </div>
        </CardContent>
      </Card>
