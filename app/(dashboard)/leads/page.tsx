  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button asChild className="bg-gradient-to-r from-orange-600 to-orange-700">
          <Link href="/leads/new">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{leadsByStatus.FOLLOW_UP.length}</div>
          </CardContent>
        </Card>
      </div>

      {/* Leads Pipeline */}
      <LeadsPipeline leadsByStatus={leadsByStatus} />
    </div>
  )
}
